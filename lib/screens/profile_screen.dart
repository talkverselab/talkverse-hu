      ...
      body: ListView(
        ...
        children: [
          ...
          _SettingsGroup(items: [
            _SettingItem(icon: Icons.volume_up, title: 'TTS 음성', subtitle: 'hu-HU (시스템 보이스)'),
            _SettingItem(icon: Icons.public, title: '변종', subtitle: '표준 (Magyarország)'),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: '저작권', subtitle: '헝가리어유니버스 · 2026'),
          ]),
