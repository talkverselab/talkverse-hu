...
/// Magyarország 컬러 팔레트 — 국기색 기반 rojo·gualda (식별자 유지)
class AppColors {
  // 主色 — Rojo (국기 빨강)
  static const Color rojo = Color(0xFFCE2939);
  static const Color rojoDeep = Color(0xFF941D29);
  static const Color rojoLight = Color(0xFFDE5A66);

  // 副色 — Gualda (국기 노랑/금)
  static const Color gualda = Color(0xFF477050);
  static const Color gualdaBright = Color(0xFF6B9A74);
  static const Color gualdaDeep = Color(0xFF335A3C);
